...
export function SettingsPage() {
  ...
  const notificationsTab = (
    <Layout>
      <Layout.Section>
        <Card>
          <BlockStack gap="400">
            <Text as="h2" variant="headingMd">Deploy &amp; alert notifications</Text>
            <Text as="p" variant="bodySm" tone="subdued">
              Where deploy results and SSL alerts are sent. Leave a field blank to disable that channel.
            </Text>
            <TextField
              label="Notify email"
              type="email"
      ...
      <Layout.Section>
        <Card>
          <BlockStack gap="400">
            <Text as="h2" variant="headingMd">Email (SMTP)</Text>
            <Text as="p" variant="bodySm" tone="subdued">
  ...
  const integrationsTab = (
    <Layout>
      <Layout.Section>
        <Card>
          <BlockStack gap="400">
            <Text as="h2" variant="headingMd">Cloudflare DNS</Text>
            <Text as="p" variant="bodySm" tone="subdued">
  ...
  const tabContent = [generalTab, notificationsTab, integrationsTab, securityTab][selectedTab]
